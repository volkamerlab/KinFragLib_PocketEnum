...
## 1. Getting started
Tutorials to run the subpocket-based docking pipeline.

### `getting_started.ipynb`
This notebook contains an introduction on how prepare the target protein structure for the subpocket-based docking pipeline.

### `getting_started_program_config.ipynb`
